...
settings-pinned-folders = Angeheftete Ordner
settings-session-pinned-folders = Angeheftete Ordner pro Sitzung halten (nicht zwischen laufenden Instanzen teilen)
