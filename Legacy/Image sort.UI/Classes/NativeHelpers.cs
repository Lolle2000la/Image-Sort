...
namespace Image_sort.UI.Classes
{
    class NativeHelpers
    {
        ...
        public static BitmapSource _adminSymbol = null;

        /// <summary>
        /// Gets the windows administrator symbol from the system.
        /// </summary>
        /// <remarks>
        /// taken from https://stackoverflow.com/questions/33285468/display-a-uac-shield-icon-next-to-a-wpf-button, 21.10.2018
        /// </remarks>
        public static BitmapSource AdminSymbol
        {
            get
            {
                // Prefer using the cached symbol to reduce p/invokes.
                if (_adminSymbol != null)
                    return _adminSymbol;

                BitmapSource shieldSource = null;

                // Windows Vista is required as a minimum to get the shield from the system.
                ...
                // Cache the symbol before returning
                _adminSymbol = shieldSource;
                return shieldSource;
            }
        }
