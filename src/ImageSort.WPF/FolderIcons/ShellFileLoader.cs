...
namespace ImageSort.WPF.FolderIcons
{
    internal static class ShellFileLoader
    {
        ...
        public static extern UIntPtr SHGetFileInfo(string pszPath, uint dwFileAttributes, ref SHFILEINFO psfi,
            uint cbfileInfo, ShellGetFileInfoFlags uFlags);
        ...
        public struct SHFILEINFO
        {
            ...
            /// <summary>
            ///     A handle to the icon that represents the file. You are responsible for destroying this handle with DestroyIcon when
